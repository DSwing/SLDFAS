...
def script_tool(param0, param1, param2, param3, param4, param5):
    ...
    result=run(["Rscript", "--vanilla", "bnet_load_1.R", param0, param1, param2, param3, param4, param5], universal_newlines=True,capture_output=True)
#    result=run(["Rscript", "--vanilla", "test.R"])

    with  open("log_boundaries.txt", "w") as f:
