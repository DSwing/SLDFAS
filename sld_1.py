...
#    param7=arcpy.Describe(param7).catalogPath

    result=run(["Rscript", "--vanilla", "sld_1v2.R", param0, param1, param2, param3, param4, param5, param6], universal_newlines=True,capture_output=True)
#    result=run(["Rscript", "--vanilla", "test.R"])

    with  open("log_sld.txt", "w") as f:
